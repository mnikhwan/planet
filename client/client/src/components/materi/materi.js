...
<section className="bawah">
    ...
    <section id="sun" className="atas hide">
        ...
        <a className="kembali tombol" onclick="m1s()">Kembali</a>
    </section>
    ...
    <section id="mercury" className="atas hide">
        ...
        <a className="kembali tombol" onclick="m2s()">Kembali</a>
    </section>
    ...
    <section id="venus" className="atas hide">
        ...
        <a className="kembali tombol" onclick="m3s()">Kembali</a>
    </section>
    ...
    <section id="earth" className="atas hide">
        ...
        <a className="kembali tombol" onclick="m4s()">Kembali</a>
    </section>
    ...
    <section id="mars" className="atas hide">
        ...
        <a className="kembali tombol"onclick="m5s()">Kembali</a>
    </section>
    ...
    <section id="jupiter" className="atas hide">
        ...
        <a className="kembali tombol" onclick="m6s()">Kembali</a>
    </section>
    ...
    <section id="saturn" className="atas hide">
        ...
        <a className="kembali tombol" onclick="m7s()">Kembali</a>
    </section>
    ...
    <section id="uranus" className="atas hide">
        ...
        <a className="kembali tombol" onclick="m8s()">Kembali</a>
    </section>
    ...
    <section id="neptune" className="atas hide">
        ...
        <a className="kembali tombol" onclick="m9s()">Kembali</a>
    </section>
